...
document.addEventListener("DOMContentLoaded", function () {
  ...
  applyAllGridItemStyles(); // document.addEventListener("DOMNodeInserted", newGridInserted);
