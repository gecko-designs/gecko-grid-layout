...
var settings = {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Experimental (Do Not Use)'),
  parent: ['gecko/grid-layout'],
    ...
    from: [{
      ...
      transform: function transform(attributes, innerBlocks) {
        ...
        var h = attributes.h,
            ...
            mediaUrl = attributes.mediaUrl,
            minHeight = attributes.minHeight;
        return Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__["createBlock"])('gecko/grid-layout-item', {
          h: h,
          w: w,
  ...
  deprecated: [{
    migrate: function migrate() {},
    save: function save() {
      return React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["InnerBlocks"].Content, null);
    }
  }],
  edit: function edit(_ref) {
    var attributes = _ref.attributes,
    ...
    return React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["Fragment"], null, React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["InspectorControls"], null, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelBody"], {
      title: "Settings"
      ...
      max: "600",
      step: "1"
    }), type !== "solid" && React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["MediaUpload"], {
      onSelect: function onSelect(value) {
        // console.log(value);
        setAttributes({
          bgMedia: value.id,
    ...
    }), React.createElement("hr", null), React.createElement("div", null, React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["ColorPalette"], {
      ...
      onChange: function onChange(value) {
        ...
        var brightness = value ? tinycolor2__WEBPACK_IMPORTED_MODULE_0___default()(value).getBrightness() : undefined;
        setAttributes({
    ...
    React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["InnerBlocks"], {
      templateLock: false
    })));
  },
  save: function save() {
    return React.createElement("div", null, React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_5__["InnerBlocks"].Content, null)); // Honestly I don't want to do this but conventions are conventions.
  }
};
